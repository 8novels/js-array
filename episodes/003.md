...
まず要素の中から2つを選び、値を比較します。`a`が比較対象の`b`より小さければ順位が上、大きければ順位が下、同じならば同点として判定します。この繰り返しにより、すべての要素が順番に並べ替えられます。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE5NjcwMjQ4MCwtNDYxODEzMDM4LC0zND
kzMzM0OCwxOTg1MTY3NjIwLC0xOTk5NjE0ODMsLTg3NDExNDE0
NywxNjQyNTI1MjgyLC0zNjM4NjA0MSwtMjEwNjExNDYwOCw1Mj
