...
- [MDN](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/Array/sort)によると……
...
`# reverse()` メソッドも、基本的な操作の一つです。
[MDN](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/Array/reverse)によると……
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTkxODUyNDA1MSwtMjEwNjExNDYwOCw1Mj
Q2MTA2NzEsLTEzODcwNTYxNTNdfQ==
-->