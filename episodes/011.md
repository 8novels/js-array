...
`reduce()`メソッドは、「コールバック関数、初期値」の
さらにコールバック関数では、「現在の要素、現在の要素のインデックス、元の配列」という3つの引数を使用できます。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTI1MzI1Nzk5NiwtMTUwMDA4OTI2NiwxNj
Y2MDE4MjcwLDE5Njg4NTEzMzldfQ==
-->