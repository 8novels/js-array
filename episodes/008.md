...
テスト関数では、「現在の要素、現在の要素のインデックス、テスト関数を実行中の配列」という3つの引数を使用できます。引数を3つとも使用したい場合は、例えば`items.filter((item, i, _items) => ...)`などというように記述します。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwMzA3NzIyNjUsMzI5Mzk0Mzk0LDkxNT
QwNDM5NSwyMTE3NDk4MTAwLDE5NzU4MzI0NDYsLTc3MzI2OTQ1
MCwzOTE2MDU2MjMsLTEyMDkzMTIxOCwxNzc3ODY3MTk0XX0=
-->