...
イ「あれい、これも念の為に解説をお願い！」
あ「ああん？　面倒くせえなあ……だから、記事アイテムの本文を順に検索して、[test()](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/RegExp/test)メソッドで`likes_count`の値が10以上のものだけを抽出してるんだよ」
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzk5NTYxODk4LC0xOTgxODI1NjQzLC0xMD
