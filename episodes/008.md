...
テスト関数では、「現在の要素、現在の要素のインデックス、テスト関数を実行中の配列」という3つの引数を使用できます。引数を3つとも使用したい場合は、たとえば`items.filter((item, i, arr) => ...)`というように記述します。
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyMDE4MzA0NzYsMzI5Mzk0Mzk0LDkxNT
