...
イ「あれい、これも念の為に解説をお願い！」
あ「ああん？　面倒くせえなあ……だから、`find()` メソッドで記事アイテムを順に検索してだな、本文に'JavaScript'って文字列があるかどうかを[test()](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/RegExp/test)メソッドで判定し、最初に見つかったアイテムを返してるんだよ」
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNTA5MzY1NTg1LC0xOTgxODI1NjQzLC0xMD
