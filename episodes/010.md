...
イ「ふむふむ」
あ「で、さらに`tags`プロパティ内のすべてのプロパティに`map()` メソッドでアクセスして、`tags.name`の値のみの配列を作成してから、それを`join()`メソッドで連結してるんだよ」
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE4MjY2MzQ3OSwtMjE0NTU4MDQwOCwtMT
UxNjgyNzIwNiwtMTQ3NDEzOTQxNyw3MTExODAwODgsMzAyNTMx
NzYsMTY1NDQ0MjU3OSwtODc3NDY5MDAsLTE3NDcxMzg4MTUsLT
