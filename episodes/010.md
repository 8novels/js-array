...
（逆に言うと、他のオブジェクトである[Map](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/Map)や[Set](https://developer.mozilla.org/ja/docs/Web/JavaScript/Reference/Global_Objects/Set)では`forEach()`くらいでしか反復処理ができないけど、Arrayオブジェクトは豊富なメソッドが揃っていて便利だなー、という事なんでしょうかね。多分）
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzY3OTAxOTExLDEyOTc4NDAwMDAsMjU5Nj
AwMDg5LDEyOTgzMzkxNDQsNTg4NzA5MDk3LDcyOTEzMTA3NCwt
MjE0NTU4MDQwOCwtMTUxNjgyNzIwNiwtMTQ3NDEzOTQxNyw3MT
ExODAwODgsMzAyNTMxNzYsMTY1NDQ0MjU3OSwtODc3NDY5MDAs
LTE3NDcxMzg4MTUsLTE4MTY5NTE0ODQsMTcxNjIwMjM4NSwtOD
