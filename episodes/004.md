...
イテレー太「さて、魔法生物である僕が魔法世界から召喚したデータを、魔法少女であるあれいの配列魔法を使って、敵の弱点に合わせた値に変換して`return`する事でダメージを与えて敵を倒す、という設定の戦闘の真っ最中だよ！」
あれい「いつまで続くんだよこの駄犬」
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTQyMTg0NDk2MCwxMTMwNzk0MTA3LC02MT
g0NzAzNTddfQ==
-->