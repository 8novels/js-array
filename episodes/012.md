...
……というわけで、魔法（マジカル）JS（女子小学生）☆あれいの物語はこれで完結です。JavaScriptで配列を操るメソッドの面白さと奥深さ、少しでも伝われば幸いです。お付き合いありがとうございました。
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTE5NjAzMDgzLC0xMTQzNzU4ODkxLDIxMT
E2MTcyNjAsLTg0MDc4OTgyNSwxMTE5MDMxNjE3XX0=
-->